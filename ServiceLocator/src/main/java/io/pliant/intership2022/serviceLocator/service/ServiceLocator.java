package io.pliant.intership2022.serviceLocator.service;
...
public interface ServiceLocator {
     ...
     * @throws ServiceLocatorException when service with that name was already registered or on exception during method execution
     */
    void register(Class<?> serviceClass, String name) throws ServiceLocatorException, InstantiationException, IllegalAccessException;
     ...
     * @throws ServiceLocatorException when service with the associated name was already registered or on exception during method execution
     */
    void register(Class<?> serviceClass) throws ServiceLocatorException, InstantiationException, IllegalAccessException;
     ...
     */
    Object get(String name) throws ServiceLocatorException, InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException, ClassNotFoundException;
     ...
     */
    <T> T get(Class<T> serviceClass) throws ServiceLocatorException, ClassNotFoundException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException;
     ...
     */
    <T> List<T> getAll(Class<T> serviceClass) throws ServiceLocatorException, ClassNotFoundException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException;
